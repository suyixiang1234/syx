...
public class Freemarker {
	 ...
	 */
	public static void printFile(String ftlName, Map<String,Object> root, String outFile, String filePath, String ftlPath, String projectPath) throws Exception{
		try {
			System.out.println(projectPath + filePath + outFile);
			File file = new File(projectPath + filePath + outFile);
