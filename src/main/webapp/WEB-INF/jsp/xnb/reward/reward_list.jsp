					...
					<c:when test="${not empty varList}">
						...
						<c:forEach items="${varList}" var="var" varStatus="vs">
							<tr>
								...
								<td class="center">${var.xuser_id}</td>
								<td class="center">${var.moneys}</td>
								<td class="center">${var.times}</td>
								<td class="center">${var.jmoneys}</td>
								...
								<td style="width: 30px;" class="center">
									<div class='hidden-phone visible-desktop btn-group'>
										<c:if test="${QX.edit == 1 }">
											<a class="btn btn-mini btn-success" title="编辑" onclick="edit('${var.reward_id}');"><i class="icon-edit icon-2x icon-only"></i></a>
										</c:if>
										<c:if test="${QX.del == 1 }">
											<a class="btn btn-mini btn-danger" title="删除" onclick="del('${var.reward_id}');"><i class="icon-trash icon-2x icon-only"></i></a>
										</c:if>
									</div>
								</td> 
								--%>
