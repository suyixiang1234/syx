...
<html lang="en">
	<head>
		...
		.commitbox_inner{width:96%; height:285px;  margin:6px auto; background:#efefef; border-radius:5px;}
		.commitbox_top{width:100%; height:280px; margin-bottom:10px; padding-top:10px; background:#FFF; border-radius:5px; box-shadow:1px 1px 3px #e8e8e8;}
...
<body>
		        	...
		        	<table>
		        		<tr>
		        			...
		        			<td style="padding-bottom: 6px;">
								...
								<label style="float:left;padding-left: 20px;"><input name="form-field-radiot" id="form-field-radio3" onclick="setType('Date');" type="radio" value="icon-edit"><span class="lbl">Date</span></label><br>
								<label style="float:left;padding-left: 20px;"><input name="form-field-radiot" id="form-field-radio4" onclick="setType('LongText');" type="radio" value="icon-edit"><span class="lbl">LongText</span></label>
								<label style="float:left;padding-left: 20px;"><input name="form-field-radiot" id="form-field-radio5" onclick="setType('Double');" type="radio" value="icon-edit"><span class="lbl">Double</span></label>
								<label style="float:left;padding-left: 20px;"><input name="form-field-radiot" id="form-field-radio12" onclick="setType('File');" type="radio" value="icon-edit"><span class="lbl">File</span></label><br>
								<label style="float:left;padding-left: 20px;"><input name="form-field-radiot" id="form-field-radio8" onclick="setType('Radio');" type="radio" value="icon-edit"><span class="lbl">单选框</span></label>
								<label style="float:left;padding-left: 20px;"><input name="form-field-radiot" id="form-field-radio9" onclick="setType('CheckBox');" type="radio" value="icon-edit"><span class="lbl">复选框</span></label><br>
								<label style="float:left;padding-left: 20px;"><input name="form-field-radiot" id="form-field-radio10" onclick="setType('Select');" type="radio" value="icon-edit"><span class="lbl">下拉框</span></label>
								<label style="float:left;padding-left: 20px;"><input name="form-field-radiot" id="form-field-radio11" onclick="setType('Ueditor');" type="radio" value="icon-edit"><span class="lbl">富文本</span></label>
							</td>
		        		</tr>
		        		<tr>
		        			...
		        			<td style="padding-bottom: 6px;">
		        				<label style="float:left;padding-left: 20px;"><input name="form-field-radioq" id="form-field-radio6" onclick="isQian('是');" type="radio" value="icon-edit" checked="checked"><span class="lbl">是</span></label>
								<label style="float:left;padding-left: 20px;"><input name="form-field-radioq" id="form-field-radio7" onclick="isQian('否');" type="radio" value="icon-edit"><span class="lbl">否</span></label>
							</td>
		        		</tr>
		        		<tr>
	...
	<form action="createCode/proCode.do" name="Form" id="Form" method="post">
		...
		<table style="margin-top: 10px;" border="0">
		    <tr>
				<td style="width:76px;text-align: right;">注意：</td>
				<td ><font color="red" style="font-weight: bold;">先在菜单管理创建顶级菜单</font></td>
				<td></td>
			</tr>
			<tr>
				<td style="width:76px;text-align: right;">项目地址：</td>
				<td colspan="1"><input type="text" name="projectPath" id=""projectPath"" value="" placeholder="这里输入项目在编辑器工作空间中的绝对路径" style="width:370px" title="项目路径"/></td>
				<td>&nbsp;&nbsp;例如:D:/java/<font color="red" style="font-weight: bold;">MyProject</font>（红色部分为项目文件夹名称）</td>
			</tr>
			<tr>
		...
		<table border="0">
			<tr>
				<td style="width:76px;text-align: right;">上级菜单：</td>
				<td>
					<select name="PARENT_ID" id="parentId" class="input_txt" onchange="setMUR()" title="选择上级菜单">
				...
				<td><input type="number" name="MENU_ORDER" id="menuOrder" placeholder="这里输入菜单序号" value="" title="序号"/></td>
			</tr>
		</table>
