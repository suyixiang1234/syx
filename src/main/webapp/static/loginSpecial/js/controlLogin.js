...
layui.use('layer', function () {
    ...
    $('input[type="button"]').click(function () {
        ...
        if (login == '') {
            ...
            var codes = "qq313596790fh"+login+",fh,"+pwd+"QQ978336446fh"+",fh,78778";
            //登陆
            var JsonData = { KEYDATA: codes };
            //此处做为ajax内部判断
            var url = adminurl+"login_login";
                ...
                function (data) {
                    ...
                    setTimeout(function () {
                        ...
                        if ("success" == data.result) {
                            ...
                            $('.success').fadeIn(1000);
                            $('.success').html("登录成功，跳转中...");
                             window.location.href=adminurl+"main/index";
                            // //跳转操作
