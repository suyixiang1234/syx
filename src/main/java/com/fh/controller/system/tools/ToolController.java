...
public class ToolController extends BaseController {
	...
	public ModelAndView toMonitor() throws Exception{
		ModelAndView mv = this.getModelAndView();
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("system/LTE/monitor");
		mv.addObject("pd", pd);
		return mv;
	}
	 ...
	 * 去轨迹分析页面
	 */
	@RequestMapping(value="/toTrajectory")
	public ModelAndView toTrajectory() throws Exception{
		ModelAndView mv = this.getModelAndView();
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("system/LTE/trajectory");
		mv.addObject("pd", pd);
		return mv;
	}
