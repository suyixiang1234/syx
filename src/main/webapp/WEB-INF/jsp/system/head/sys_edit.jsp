 ...
 <div class="span6">
	<div class="tabbable">
            <ul class="nav nav-tabs" id="myTab">
              <li class="active"><a data-toggle="tab" href="#home"><i class="green icon-home bigger-110"></i> 应用配置 </a></li>
            ...
            <div class="tab-content">
			  <div id="home" class="tab-pane in active">
				...
				<table id="table_report" class="table">
					...
					<tr>
						<td style="width:50px;text-align: right;padding-top: 13px;">HOST:</td>
						<td><input type="text" name="HOST" id="HOST" value="${pd.HOST }" placeholder="例如:smtp.qq.com" style="width:90%" title="SMTP"/></td>
					
						<td style="width:50px;text-align: right;padding-top: 13px;">应用id:</td>
						<td><input type="text" name="TOPIC" id="TOPIC" value="${pd.TOPIC }" placeholder="一般为：25" style="width:90%" title="端口"/></td>
					</tr>
					<tr>
						<td style="width:50px;text-align: right;padding-top: 13px;">用户:</td>
						<td><input type="text" name="userName" id="userName" value="${pd.userName }" placeholder="请输入mqtt用户" style="width:90%" title="邮箱"/></td>
					
						<td style="width:50px;text-align: right;padding-top: 13px;">密码:</td>
						<td><input type="text" name="passWord" id="passWord" value="${pd.passWord }" placeholder="请输入mqtt密码" style="width:90%" title="密码"/></td>
					</tr>
				</table> 
				--%>
				...
				<table id="table_report" class="table table-striped table-bordered table-hover">
					...
					<tr>
						<td style="width:50px;text-align: right;padding-top: 13px;">比例值:</td>
						<td><input type="number" name="TOPIC" id="TOPIC" value="${pd.TOPIC }" placeholder="请输入比例值" style="width:90%" /></td>
				...
				<table id="table_report" class="table table-striped table-bordered table-hover">
					...
					<tr>
						<td style="width:50px;text-align: right;padding-top: 13px;">比例值:</td>
						<td><input type="number" name="BAOJING" id="BAOJING" value="${pd.BAOJING }" placeholder="请输入比例值" style="width:90%" /></td>
					</tr>
				...
				<table id="table_report" class="table table-striped table-bordered table-hover">
					...
					<tr>
						<td style="width:50px;text-align: right;padding-top: 13px;">比例值:</td>
						<td><input type="number" name="HOST" id="HOST" value="${pd.HOST }" placeholder="请输入比例值" style="width:90%"/></td>
					</tr>
				...
				<table id="table_report" class="table table-striped table-bordered table-hover">
					...
					<tr>
						<td style="width:50px;text-align: right;padding-top: 13px;">银行名称:</td>
						<td><input type="text" name="userName" id="userName" value="${pd.userName }"  style="width:90%"/></td>
					</tr>
					
					<tr>
						<td style="width:50px;text-align: right;padding-top: 13px;">所属支行:</td>
						<td><input type="text" name="passWord" id="passWord" value="${pd.passWord }"  style="width:90%"/></td>
					</tr>
					
					<tr>
						<td style="width:50px;text-align: right;padding-top: 13px;">银行账户:</td>
						<td><input type="text" name="EMAIL" id="EMAIL" value="${pd.EMAIL }"  style="width:90%"/></td>
					</tr>
					
					<tr>
						<td style="width:50px;text-align: right;padding-top: 13px;">收款卡号:</td>
						<td><input type="text" name="SMS1" id="SMS1" value="${pd.SMS1 }"  style="width:90%"/></td>
					</tr>
