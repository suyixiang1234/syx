...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>标准化框架·</b>平台</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li><a href="<%=basePath%>main/index"><i class="fa fa-circle-o text-aqua"></i> <span>前往首页</span></a></li>
         		 ...
         		 <c:forEach items="${menu.subMenu}" var="sub">
					...
					<c:choose>
						<c:when test="${not empty sub.MENU_URL}">
						 <li class="active">
						 <a href="javascript:void(0);"   onclick="tags('${sub.MENU_URL }','${sub.MENU_NAME }');"><i class="fa fa-circle-o text-aqua"></i>${sub.MENU_NAME }</a>
						 </li>
						</c:when>
						<c:otherwise>
						</c:otherwise>
        ...
        <li><a href="javascript:void(0);"   onclick="tags('menu','菜单管理');"><i class="fa fa-circle-o text-yellow"></i> <span>菜单管理</span></a></li>
        <li><a href="javascript:void(0);"   onclick="tags('head/goProductCode.do','代码生成');"><i class="fa fa-circle-o text-green"></i> <span>代码生成</span></a></li>
        <li><a href="javascript:void(0);"   onclick="tags('head/goSystem.do','系统设置');"><i class="fa fa-circle-o text-red"></i>  <span>系统设置</span></a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       <div id="setTitle">管理中心-首页</div>
     <!--   <small><div id="setTitle">首页</div></small>  -->
      </h1>
      <ol class="breadcrumb">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2018-2020 <a href="https://adminlte.io">管理</a>.</strong> All rights
    reserved.
  </footer>
...
<script src="<%=basePath%>/static/js/tkjs/js/hullabaloo.js"></script>
...
<script>
  ...
  $(function () {
    ...
    /*
     * BAR CHART
     * ---------//['产品部33', 10],['业务部', 20],['研发部', 30],['综合部', 3], ['前端部', 8]]
     */
    var bar_data = {
      data : [${statistics.departmentList}], 
      color: '#3c8dbc'
    }
    //console.info("bar_data="+bar_data.data);
    ...
    /**标签数量分布**/
    var tag_bar_data = {
      data : [${statistics.tagDistributionList}], 
      color: '#00c0ef'
    }
    //console.info("tag_bar_data="+tag_bar_data.data);
    $.plot('#tag-bar-chart', [tag_bar_data], {
      grid  : {
        borderWidth: 1,
        borderColor: '#f3f3f3',
        tickColor  : '#f3f3f3'
    ...
    /**锚点数量分布**/
	var anchor_bar_data = {
      data : [${statistics.distributionList}], 
      color: '#0073b7'
    }
    //console.info("anchor_bar_data="+anchor_bar_data.data);
    $.plot('#anchor-bar-chart', [anchor_bar_data], {
      grid  : {
        borderWidth: 1,
        borderColor: '#f3f3f3',
        tickColor  : '#f3f3f3'
   ...
   //标签统计图
     var tagDonutData = [
		${statistics.tagNumList}
      ]
      $.plot('#tag-donut-chart', tagDonutData, {
        series: {
          pie: {
            show       : true,
            radius     : 1,
		...
		websocket.onmessage = function(evnt) {
			 ...
			 if(data[0]=="d") {
				...
				// $("#set_data").prepend(htmld); 
			     ...
			     $.hulla.send(data.slice(1), "danger");
