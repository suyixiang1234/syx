 ...
 */	
	...
	function editField(value,msgIndex){
		...
		if(efieldarray[1] == 'String'){
			...
			$("#dtype").val('Integer');
		}else if(efieldarray[1] == 'Date'){
			$("#form-field-radio3").attr("checked",true);
			$("#dtype").val('Date');
		}else if(efieldarray[1] == 'File'){
			$("#form-field-radio12").attr("checked",true);
			$("#dtype").val('File');
		}else if(efieldarray[1] == 'Radio'){
			$("#form-field-radio8").attr("checked",true);
			$("#dtype").val('Radio');
		}else if(efieldarray[1] == 'CheckBox'){
			$("#form-field-radio9").attr("checked",true);
			$("#dtype").val('Checkbox');
		}else if(efieldarray[1] == 'Select'){
			$("#form-field-radio10").attr("checked",true);
			$("#dtype").val('Select');
		}else if(efieldarray[1] == 'Ueditor'){
			$("#form-field-radio11").attr("checked",true);
			$("#dtype").val('Ueditor');
		}
		if(efieldarray[3] == '是'){
			$("#form-field-radio6").attr("checked",true);
